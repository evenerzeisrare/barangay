...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // Handle image upload
    $image_path = $service['image']; // Keep existing image by default
                    ...
                    <form method="POST" action="" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <?php if (!empty($service['image'])): ?>
                                <div class="mb-2">
                                    <img src="../<?php echo htmlspecialchars($service['image']); ?>" class="img-thumbnail" style="max-width: 200px;" alt="Current Image">
                                </div>
                            <?php endif; ?>

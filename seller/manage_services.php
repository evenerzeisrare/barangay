                                ...
                                <tr>
                                    <td>
                                        <?php if ($service['image']): ?>
                                            <img src="data:image/jpeg;base64,<?php echo base64_encode($service['image']); ?>" class="img-thumbnail" style="width: 80px; height: 80px; object-fit: cover;" alt="<?php echo $service['title']; ?>">
                                        <?php else: ?>
